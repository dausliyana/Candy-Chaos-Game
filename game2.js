...
monsterImg.src = "monster2.png";

const bgImg = new Image();
bgImg.src = "background2.jpg";
...
function checkCollisions() {
  ...
  if (monsters.length === 0 && !treasureVisible && !treasureClicked) {
...
function checkImageAnswer(isCorrect) {
  if (isCorrect) {
    ...
    alert("Oops! That's not the correct image. Try again!");
  }
}
